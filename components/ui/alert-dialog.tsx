...
>(({ className, ...props }, ref) => {
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn(
        'z-50 bg-neutral-800/90 flex justify-center items-center p-2',
    ...
    <AlertDialogPortal hostName={portalHost}>
      <AlertDialogOverlay>
        <AlertDialogPrimitive.Content
          ref={ref}
          className={cn(
            'z-50 max-w-lg gap-4 border border-neutral-100 bg-white p-6 shadow-lg shadow-foreground/10 web:duration-200 rounded-[0.75rem]',
            open
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn('text-lg native:text-xl text-foreground font-display-semibold', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn('text-sm native:text-base text-muted-foreground font-display', className)}
    {...props}
  />
));
