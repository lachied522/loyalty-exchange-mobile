...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(start)/context/StartContext` | `/context/StartContext` | `/(start)/forgot-password` | `/forgot-password` | `/(start)/login` | `/login` | `/(start)/onboarding` | `/onboarding` | `/(start)/signup` | `/signup` | `/(start)/welcome` | `/welcome` | `/(tabs)/account/` | `/account/` | `/(tabs)/account` | `/(tabs)/context/MainContext` | `/context/MainContext` | `/(tabs)/home/components/account-icon` | `/home/components/account-icon` | `/(tabs)/home/components/points-table` | `/home/components/points-table` | `/(tabs)/home/components/reward-modal` | `/home/components/reward-modal` | `/(tabs)/home/components/reward` | `/home/components/reward` | `/(tabs)/home/components/rewards-table` | `/home/components/rewards-table` | `/(tabs)/home/components/transactions-table` | `/home/components/transactions-table` | `/(tabs)/home/` | `/home/` | `/(tabs)/home` | `/(tabs)/layout` | `/layout` | `/(tabs)/rewards/` | `/rewards/` | `/(tabs)/rewards` | `/context/GlobalContext` | `/lib/basiq` | `/lib/supabase` | `/types/basiq` | `/types/helpers` | `/types/supabase` | `/utils/crud` | `/utils/functions` | `/utils/transactions`;
  // prettier-ignore
