...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(main)/context/MainContext` | `/context/MainContext` | `/(main)/context/MainReducer` | `/context/MainReducer` | `/(main)/home/account-screen` | `/home/account-screen` | `/(main)/home/components/all-transactions-table` | `/home/components/all-transactions-table` | `/(main)/home/components/exchange-dialog` | `/home/components/exchange-dialog` | `/(main)/home/components/loyalty-info-modal` | `/home/components/loyalty-info-modal` | `/(main)/home/components/points-table` | `/home/components/points-table` | `/(main)/home/components/redeemed-table` | `/home/components/redeemed-table` | `/(main)/home/components/refresh-trigger` | `/home/components/refresh-trigger` | `/(main)/home/components/reward-card` | `/home/components/reward-card` | `/(main)/home/components/reward-modal` | `/home/components/reward-modal` | `/(main)/home/components/reward-trigger` | `/home/components/reward-trigger` | `/(main)/home/components/rewards-list` | `/home/components/rewards-list` | `/(main)/home/exchange-modal` | `/home/exchange-modal` | `/(main)/home/home-screen` | `/home/home-screen` | `/(main)/home/` | `/home/` | `/(main)/home` | `/(main)/home/my-rewards` | `/home/my-rewards` | `/(start)/context/StartContext` | `/context/StartContext` | `/(start)/forgot-password/` | `/forgot-password/` | `/(start)/forgot-password` | `/(start)/login/` | `/login/` | `/(start)/login` | `/(start)/onboarding/` | `/onboarding/` | `/(start)/onboarding` | `/(start)/signup/` | `/signup/` | `/(start)/signup` | `/(start)/welcome/` | `/welcome/` | `/(start)/welcome` | `/context/GlobalContext` | `/context/GlobalReducer` | `/lib/basiq` | `/lib/supabase` | `/types/basiq` | `/types/helpers` | `/types/supabase` | `/utils/crud` | `/utils/formatting` | `/utils/functions` | `/utils/server` | `/utils/transactions`;
  // prettier-ignore
