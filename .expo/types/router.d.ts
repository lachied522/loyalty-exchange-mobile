...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(start)/context/StartContext` | `/context/StartContext` | `/(start)/forgot-password` | `/forgot-password` | `/(start)/login` | `/login` | `/(start)/onboarding` | `/onboarding` | `/(start)/signup` | `/signup` | `/(start)/welcome` | `/welcome` | `/context/GlobalContext` | `/context/GlobalReducer` | `/home/account-screen` | `/home/components/all-transactions-table` | `/home/components/exchange-dialog` | `/home/components/loyalty-info-modal` | `/home/components/points-table` | `/home/components/refresh-trigger` | `/home/components/reward-card` | `/home/components/reward-modal` | `/home/components/reward-trigger` | `/home/components/rewards-list` | `/home/components/rewards-table` | `/home/context/MainContext` | `/home/exchange-modal` | `/home/home-screen` | `/home/` | `/home/my-rewards` | `/lib/basiq` | `/lib/supabase` | `/types/basiq` | `/types/helpers` | `/types/supabase` | `/utils/crud` | `/utils/functions` | `/utils/transactions`;
  // prettier-ignore
